...
% The year in which the course is being taught. The only thing that changes at
% rollover: the year repository is always ccarrollATjhuecon/Choice-<CourseYear>.
\newcommand{\CourseYear}{2026}
% The year repository, with break opportunities: \texttt{} cannot hyphenate, and
% the bare URL overflows the text width by 157pt without them.
\newcommand{\CourseRepo}{github.com/\allowbreak ccarrollATjhuecon/\allowbreak Choice-\CourseYear}
...
\item[Lecture notes] the book \href{https://intertemporal-choice.github.io}{\texttt{intertemporal-choice.github.io}}; each section of this syllabus links to its part.
\item[This year's problem sets, exams, and class recordings] the private repository \href{https://github.com/ccarrollATjhuecon/Choice-\CourseYear}{\texttt{\CourseRepo}}. Access is by invitation: send your GitHub username to the TA. Create the account with your JHU address and apply for \href{https://github.com/education/students}{GitHub Education} (free).
\item[Past exams, with answers] \href{https://github.com/ccarrollATjhuecon/Choice-\CourseYear}{\texttt{\CourseRepo}}, in \texttt{Exams/} --- a rolling window of the six most recent years, each exam both as it was given and with an answer key.
...
\texttt{\href{https://intertemporal-choice.github.io}{intertemporal-choice.github.io}}
...
\item[Handouts:] \texttt{\href{https://intertemporal-choice.github.io/content/consumption}{Consumption}}
\item[Readings:]
\end{itemize}
...
\item[Handouts:]  \texttt{\href{https://intertemporal-choice.github.io/content/investment}{Investment}}
\item[Readings:]
\end{itemize}
...
\item[Handouts:]  \texttt{\href{https://intertemporal-choice.github.io/content/growth}{Growth}}
\end{itemize}
\bi
...
\item[Handouts:]  \texttt{\href{https://intertemporal-choice.github.io/content/dsge}{DSGEModels}}
\end{itemize}
